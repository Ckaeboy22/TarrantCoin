...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x2ce99c;
        ...
        const uint64_t MONEY_SUPPLY = UINT64_C(2'000'000'000'000'00);
    ...
    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xb8, 0x0e, 0x4b, 0x6b, 0xce, 0x57, 0x59, 0x42, 0x67, 0xf4, 0x96, 0xa7, 0xb5, 0xc4, 0x46, 0xe8}};
